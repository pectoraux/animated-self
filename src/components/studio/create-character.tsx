...
// ---------------------------------------------------------------------------
// Liveness → bind dialog
// ---------------------------------------------------------------------------

type LivenessPhase =
  | { kind: "idle" }
  | { kind: "requesting" }
  | { kind: "challenge"; challenge: LivenessChallenge; cameraStarted: boolean; verifying: boolean; progress: number }
  | { kind: "binding" }
  | { kind: "done" }
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-neutral-300">
                      ...
                      face evidence. {character.name} is now selectable in the
                      picker.
                    </p>
                  </div>
                </motion.div>
